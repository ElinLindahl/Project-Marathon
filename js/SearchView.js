	...
	this.update = function(obj){
		...
		if (obj){
			...
			for(i = 0; i < Movies.length; i++){
				str += "<div class='moviebox' ondrop='drop(event)' ondragover='allowDrop(event)'><div class='movie' id='m"+i+"' onclick='showInfo("+Movies[i].id+")' draggable='true' ondragstart='drag(event)'>";
				str += Movies[i].title;
